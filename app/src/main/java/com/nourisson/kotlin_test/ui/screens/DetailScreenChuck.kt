...
fun DetailScreenChuck(
    ...
    Column(horizontalAlignment = Alignment.CenterHorizontally,
        ...
        MyTopBar()
        GlideImage(
            model = "https://api.chucknorris.io/img/chucknorris_logo_coloured_small.png",
            //Dans string.xml
            //contentDescription = getString(R.string.picture_of_cat),
            //En dur
            contentDescription = "une photo de chuck",
